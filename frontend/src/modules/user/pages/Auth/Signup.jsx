        ...
        setTimeout(() => {
            ...
            if (result.success) {
                toast({
                    ...
                    description: "Welcome to the future of play.",
                    variant: "default",
                });
                navigate('/home');
            } else {
            ...
            >
                <div className="bg-secondary/10 backdrop-blur-xl border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl">
                    <div className="text-center mb-10">
                        <h1 className="text-4xl font-black italic tracking-tighter text-white mb-2">JOIN THE CLUB</h1>
                        <p className="text-white/60">Create your account to start collecting.</p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            <label className="text-xs font-bold uppercase tracking-widest text-white/50 ml-4">Full Name</label>
                            <div className="relative">
                                <User className="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-white/40" />
                                <input
                                    type="text"
                                    required
                                    value={formData.name}
