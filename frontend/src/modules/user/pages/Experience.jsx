                        ...
                        {experiencePage.footer.buttons.map((btn, i) => (
                            <a key={i} href={btn.link} className="w-full md:w-auto">
                                <Button
                                    ...
                                    className={`w-full md:w-64 h-20 rounded-full text-xl font-black italic tracking-tighter shadow-2xl ${btn.variant === 'outline' ? 'border-2 border-white/10 hover:bg-white hover:text-black' : ''
                                        }`}
                                >
                                    {btn.text}
                                </Button>
